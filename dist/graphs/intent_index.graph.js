                ...
                try {
                    ...
                    if (state.skipEvaluation) {
                        ...
                        return {
                            ...
                            assignmentResult: { indexId, assigned: true, success: true },
                    ...
                    const result = await indexer.evaluate(intentForIndexing.payload, indexContext.indexPrompt, indexContext.memberPrompt, sourceName);
                    ...
                    return {
                        ...
                        shouldAssign: false,
                        finalScore,
                        assignmentResult: { indexId, assigned: false, success: true },
...
//# sourceMappingURL=intent_index.graph.js.map